...
import dataset
from models import pose_resnet_2

import  sys
root_path = os.path.realpath(__file__).split('/pose_estimation/train_2.py')[0]
os.chdir(root_path)
...
def main():
    ...
    model = pose_resnet_2.get_pose_net(
    ...
    state_dict=torch.load(model_state_file)['state_dict']
